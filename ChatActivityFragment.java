...
public class ChatActivityFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button btnConnectionError = (Button) v.findViewById(R.id.btnConnectionnErr);
        ...
        final Button btnRandom = (Button) v.findViewById(R.id.btnRndmId);
        btnRandom.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
               int UpperRange = 1000000;
               final Random r = new Random();
               final int a = (r.nextInt(UpperRange));
        ...
        textView = (TextView) v.findViewById(R.id.randomNum);
    ...
    private void ConnectionError(){
        Bundle data = new Bundle();
        data.putInt(ChatService.MSG_CMD, ChatService.SEND_ERROR_CONNECT_50);
        Intent intent = new Intent(getContext(), ChatService.class);
        intent.putExtras(data);
        getActivity().startService(intent);
    }

    private void randomID(String b){
        Bundle data = new Bundle();
        data.putInt(ChatService.MSG_CMD, ChatService.CMD_RANDOM_ID);
        data.putString(ChatService.KEY_R_ID,b);
        Intent intent = new Intent(getContext(), ChatService.class);
        intent.putExtras(data);
        getActivity().startService(intent);
    }
